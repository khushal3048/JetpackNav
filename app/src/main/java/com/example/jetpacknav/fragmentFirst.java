...
public class fragmentFirst extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
            ...
            btn_sec = view.findViewById(R.id.btn_first);
            ...
            View.OnClickListener ls = Navigation.createNavigateOnClickListener(R.id.action_fragmentFirst_to_fragmentSecond, bundle);

            btn_sec.setOnClickListener(ls);
